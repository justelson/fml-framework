        ...
        case 'chapter':
          return (
            <div key={idx} style={{ marginBottom: '1rem', paddingBottom: '1rem', borderBottom: '1px dashed var(--line)' }}>
              <strong style={{ display: 'block', color: 'var(--signal)', marginBottom: '0.25rem' }}>{block.title}</strong>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {docs.sections.map(s => (
              <button
                ...
                style={{
                  textAlign: 'left',
                  background: activeSection === s.id ? 'var(--panel-bg)' : 'transparent',
          ...
          <div className="chapter-work-area">
            <Container title="Groq API Key">
              <p className="sub-intro">
                ...
                Get your free API key from <a href="https://console.groq.com" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>console.groq.com</a>
              </p>
              ...
              <div style={{ display: 'flex', gap: '8px', marginTop: '12px', flexWrap: 'wrap' }}>
                ...
                <button className="action" type="button" onClick={handleClear} style={{ background: 'var(--panel-bg)', color: 'var(--text)', border: '1px solid var(--border)' }}>
                  Clear Key
                </button>
                <button
                  className="action"
                  ...
                  style={{ background: 'var(--panel-bg)', color: 'var(--text)', border: '1px solid var(--border)' }}
                >
                  {showKey ? 'Hide' : 'Show'}
                </button>
              </div>
          ...
          <div className="chapter-explainer">
            ...
            <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem', marginBottom: '1.5rem' }}>
              ...
              <div style={{ fontSize: '0.9rem', color: 'var(--muted)', lineHeight: '1.6' }}>
                Your API key is stored in browser <strong>localStorage</strong> only. No intermediate servers have access to your key.
              </div>
            </div>

            <h4>How to Get Key</h4>
            <ol className="steps">
              <li>Visit <a href="https://console.groq.com" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>console.groq.com</a></li>
