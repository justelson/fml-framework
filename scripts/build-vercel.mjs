...
function main() {
  ...
  cpSync(resolve(root, 'portal', 'docs-user.html'), resolve(deployDir, 'docs-user.html'));
  cpSync(resolve(root, 'portal', 'docs-developer.html'), resolve(deployDir, 'docs-developer.html'));
